        ...
        if (!canvas) {
          ...
          Promise.all([
            ...
            const { width: backgroundWidth, height: backgroundHeight } =
              backgroundImage;
            const { width: selectedColorWidth, height: selectedColorHeight } =
              selectedColorSvg;
            ...
            if (worker) {
              const backgroundImageBufferData: ArrayBufferLike =
                loadImageBufferWithSize(backgroundImage);
              const circleImageBufferData: ArrayBufferLike =
                loadImageBufferWithSize(selectedColorSvg);
              ...
              worker.postMessage(
                ...
                [offscreen, backgroundImageBufferData, circleImageBufferData]
              );
            }
